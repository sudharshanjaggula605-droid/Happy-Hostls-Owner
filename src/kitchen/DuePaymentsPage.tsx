...
export const DuePaymentsPage: React.FC<DuePaymentsPageProps> = ({
  ...
  const [dueResidents, setDueResidents] = useState<DueResidentItem[]>([
    { id: 'dr-1', name: 'Vikram Patel', roomNumber: '204', phone: '+91 98765 11223', amountDue: 8500, totalAmount: 8500, amountPaid: 0, month: 'July 2026', dueDate: '05 Jul 2026', daysOverdue: 28, lastReminderSent: '25 Jul 2026' },
    { id: 'dr-2', name: 'Rohan Sharma', roomNumber: '102', phone: '+91 98765 22334', amountDue: 7200, totalAmount: 7200, amountPaid: 0, month: 'July 2026', dueDate: '10 Jul 2026', daysOverdue: 23, lastReminderSent: '26 Jul 2026' },
    { id: 'dr-3', name: 'Anish Giri', roomNumber: '305', phone: '+91 98765 33445', amountDue: 6500, totalAmount: 6500, amountPaid: 0, month: 'July 2026', dueDate: '15 Jul 2026', daysOverdue: 18, lastReminderSent: '27 Jul 2026' },
    { id: 'dr-4', name: 'Siddharth Rao', roomNumber: '101', phone: '+91 98765 44556', amountDue: 6500, totalAmount: 6500, amountPaid: 0, month: 'July 2026', dueDate: '20 Jul 2026', daysOverdue: 13, lastReminderSent: '28 Jul 2026' },
    { id: 'dr-5', name: 'Pooja Hegde', roomNumber: '208', phone: '+91 98765 55667', amountDue: 9000, totalAmount: 9000, amountPaid: 0, month: 'July 2026', dueDate: '20 Jul 2026', daysOverdue: 13, lastReminderSent: '28 Jul 2026' },
    { id: 'dr-6', name: 'Tarun Kumar', roomNumber: '110', phone: '+91 98765 66778', amountDue: 5800, totalAmount: 5800, amountPaid: 0, month: 'July 2026', dueDate: '25 Jul 2026', daysOverdue: 8, lastReminderSent: '30 Jul 2026' },
  ]);
  ...
  const handleOpenCollectModal = (item: DueResidentItem) => {
  ...
  const handleProcessFeePayment = (e: React.FormEvent) => {
    ...
    if (onCollectPayment) {
      onCollectPayment(selectedCollectItem.id, payAmt);
    }

    setDueResidents(prev =>
      prev
        .map(item => {
      ...
      <div className="odp-list">
        {filteredResidents.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '30px', color: '#64748b', fontSize: '14px' }}>
            {dueResidents.length === 0 ? 'All resident dues have been collected!' : `No overdue residents found matching "${searchQuery}".`}
          </div>
        ) : (
